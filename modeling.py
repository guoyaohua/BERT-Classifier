...
class BertModel(object):
    ...
    def __init__(self,
        ...
        with tf.variable_scope(scope, default_name="bert", reuse=tf.AUTO_REUSE):
            ...
            with tf.variable_scope("encoder"):
                ...
                self.all_encoder_layers, self.all_layer_attention_probs = transformer_model(
                    input_tensor=self.embedding_output,
    ...
    def get_all_layer_attention_probs(self):
        return self.all_layer_attention_probs
...
def transformer_model(input_tensor,
    ...
    if do_return_all_layers:
        ...
        return final_outputs, all_layer_attention_probs
    else:
        final_output = reshape_from_matrix(prev_output, input_shape)
        return final_output, all_layer_attention_probs
